...
2. Connect to $m$ vertices with probability:
  $$
  \pi(u) \propto k_u
  $$
...
1. Add a vertex
2. Connect to [$m$]{.fragment .highlight-red fragment-index=2} vertices with probability:
  $$
...
::::
::::{.column width="50%"}
### General Preferential Attachment Tree
