...
**If there exists a positive function a** - Type I/Gumbel/$\mathcal D(\Lambda)$: $$
\lim_{x\uparrow x_F} \displaystyle\frac{\bar F(x+ta(x))}{\bar F(x)} = e^{-t},\quad \forall t\in\mathbb R
$$ **If** $x_F=\infty$:  - Type II/Fréchet/$\mathcal D (\Phi_\alpha)$: $$
