...
As show by @fig-fits1 the model seems to fit the data quite well, below are some plot summarising each of the paramters for each of the models:
...
p = ggplot(df,aes(x=log(a))) +stat_density() +
  theme( 
