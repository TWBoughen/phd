...
## Barabási-Albert Model @Barabasi99 {.smaller}
...
sliderInput("xi", expression(xi), 
            min = -1, max = 1, value = 0.5, step=0.05, width="150px", ticks=FALSE)
sliderInput("a", expression(alpha), 
            min = 0, max = 10, value = 0.5, step=0.1, width="150px", ticks=FALSE)
sliderInput("sig", expression(sigma), 
            min = 1, max = 100, value = 30, step=0.1, width="150px", ticks=FALSE)
sliderInput("v", expression(v), 
            min = 1, max = 100, value = 30, step=0.1, width="150px", ticks=FALSE)
```
:::
...
```{r}
plotOutput("mixplot", height = '150px', width="200px")
```
:::
...
output$mixplot<-renderPlot({
  ...
  q = p_mix(k,input$v,phi,input$a,input$xi,input$sig)
